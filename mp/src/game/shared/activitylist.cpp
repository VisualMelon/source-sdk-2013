...
//
//=============================================================================//
// BG2 - VisualMelon - Porting - Initial Port Completed at 17:32 20/01/2014
#include "cbase.h"
...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_ATTACK );
	...
	//REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_START ); // BG2 - VisualMelon - Porting - Not in 2007 code base - commented
	//REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_FINISH ); // BG2 - VisualMelon - Porting - Not in 2007 code base - commented
...
//===========================
	...
	*/
	...
	REGISTER_SHARED_ACTIVITY( ACT_BG2_IRONSIGHTS_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_BG2_IRONSIGHTS_WALK );
	REGISTER_SHARED_ACTIVITY( ACT_BG2_IRONSIGHTS_RECOIL );
	REGISTER_SHARED_ACTIVITY( ACT_FORCE_STABLE );
	REGISTER_SHARED_ACTIVITY( ACT_FORCE_STABLE_EMPTY );
	//
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK_EMPTY );
	//
...
//BG2
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_ATTACK_MELEE_BAYONET );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_MUSKET );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_GESTURE_RELOAD_CARBINE );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_GESTURE_RELOAD_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_CANNON_SHOOT );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_CANNON_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_CANNON_RIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_BG2_CANNON_IDLE );
//
...
//HL2MP
	...
	//REGISTER_SHARED_ACTIVITY ( ACT_MP_CROUCHWALK_DEPLOYED ); // BG2 - VisualMelon - Porting - Not in 2007 code base - commented
	...
	//REGISTER_SHARED_ACTIVITY ( ACT_MP_CROUCHWALK_DEPLOYED_PRIMARY ); // BG2 - VisualMelon - Porting - Not in 2007 code base - commented
	//REGISTER_SHARED_ACTIVITY ( ACT_MP_CROUCH_DEPLOYED_IDLE_PRIMARY ); // BG2 - VisualMelon - Porting - Not in 2007 code base - commented
