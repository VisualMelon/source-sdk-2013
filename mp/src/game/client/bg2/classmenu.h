...
class CSkinButton : public vgui::ToggleButton
{
	...
	virtual void ApplySettings( KeyValues *inResourceData )
	{
		Q_strncpy( ImageBrit, (const char *)inResourceData->GetString( "ImageBrit", "" ), 80 );
		Q_strncpy( MouseoverImageBrit, (const char *)inResourceData->GetString( "MouseoverImageBrit", "" ), 80 );
		Q_strncpy( ImageAmer, (const char *)inResourceData->GetString( "ImageAmer", "" ), 80 );
		Q_strncpy( MouseoverImageAmer, (const char *)inResourceData->GetString( "MouseoverImageAmer", "" ), 80 );
	...
	char ImageBrit[80],
		ImageAmer[80],
		MouseoverImageBrit[80],
		MouseoverImageAmer[80];
...
class CStatsButton : public vgui::ToggleButton
{
	...
	void GetWeaponImage( char *m_szImage );
	virtual void ApplySchemeSettings(vgui::IScheme *pScheme);
	virtual void Paint( void );
	virtual void ApplySettings( KeyValues *inResourceData )
	{
		...
		Q_strncpy( BInf2, (const char *)inResourceData->GetString( "BInfImage2", "" ), 80 );
		Q_strncpy( ASki1, (const char *)inResourceData->GetString( "ASkiImage1", "" ), 80 );
		Q_strncpy( ASki1_shot, (const char *)inResourceData->GetString( "ASkiImage1_shot", "" ), 80 );
		Q_strncpy( ASki2, (const char *)inResourceData->GetString( "ASkiImage2", "" ), 80 );
		Q_strncpy( BSki1, (const char *)inResourceData->GetString( "BSkiImage1", "" ), 80 );
		Q_strncpy( BSki2, (const char *)inResourceData->GetString( "BSkiImage2", "" ), 80 );
		Q_strncpy( BLight1, (const char *)inResourceData->GetString( "BLightImage1", "" ), 80 );
		Q_strncpy( BLight1_shot, (const char *)inResourceData->GetString( "BLightImage1_shot", "" ), 80 );

		BaseClass::ApplySettings( inResourceData );
	}

	// BG2 - VisualMelon - these are stolen from CWeaponButton also
	char BLight1[80], BInf1[80], BInf2[80], AInf1[80], AInf2[80], AInf3[80], ASki1[80], ASki2[80], BSki1[80], BSki2[80];
	// BG2 - VisualMelon - additional ones for weapons with shot option
	char BLight1_shot[80], ASki1_shot[80];
};
