...
// $NoKeywords: $
//=============================================================================//
// BG2 - VisualMelon - Porting - Initial Port Completed at 22:31 21/01/2014
#include "cbase.h"
#include "hud.h"
...
void CHL2MPClientScoreBoardDialog::PaintBackground()
{
	...
	// BG2 - VisualMelon - Porting - mostly an overwrite
...
//-----------------------------------------------------------------------------
oid CHL2MPClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
